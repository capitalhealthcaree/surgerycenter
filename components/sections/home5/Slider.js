        ...
        <>
            <section className="slider-area">
                <Slider {...settings} className="slider-active">
                    <div className="single-slider slider-bg" data-background="/assets/img/banner/banner_bg_1.jpg">
                    ...
                    <div className="single-slider slider-bg" data-background="/assets/img/banner/banner_bg_2.jpg">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="slider-content">
                    ...
                    <div className="single-slider slider-bg" data-background="/assets/img/banner/banner_bg_3.jpg">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="slider-content">
                    ...
                    <div className="single-slider slider-bg" data-background="/assets/img/banner/banner_bg_4.jpg">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="slider-content">
