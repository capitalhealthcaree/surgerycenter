...
export default function Layout({ headerStyle, headTitle, breadcrumbTitle, children }) {
    ...
    return (
        <>
            ...
            {headerStyle == 5 ? <Header5 scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu}  isOffcanvus={isOffcanvus} handleOffcanvus={handleOffcanvus} /> : null}
